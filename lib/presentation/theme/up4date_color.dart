...
@immutable
class Up4DateColor extends Color implements WidgetStateProperty<Color> {
  const Up4DateColor(
    super.value, {
    Color? light,
    Color? dark,
...
extension Up4DateColorExtensions on Up4DateColor {
  Up4DateColor lerp(Up4DateColor? other, double t) {
    return Up4DateColor(
